...
def main(argv):
    ...
    # account
    service, flags = sample_tools.init(argv, "mybusiness", "v1", __doc__, __file__, scope="https://www.googleapis.com/auth/business.manage", discovery_filename=discovery_doc)
